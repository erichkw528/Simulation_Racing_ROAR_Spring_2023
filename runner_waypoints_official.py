...
from ROAR.agent_module.special_agents.official_waypoint_generating_agent import OfficialWaypointGeneratigAgent
...
def main(args):
    ...
    try:
        ...
        # agent = ForwardOnlyAgent(vehicle=my_vehicle,
                         # agent_settings=agent_config)
        agent = OfficialWaypointGeneratigAgent(vehicle=my_vehicle, agent_settings=agent_config)
